<template>
  <div class="hiddenDangerContainer">
    <apptitle :title="'巡检明细'"></apptitle>
    <div class="content">
      <div
...
export default class HiddenDangerDetails extends Vue {
  ...
  mounted() {
    this.getXcxjByDateAndArea(this.$route.query);
  ...
  getXcxjByDateAndArea(v) {
    Api.getXcxjByDateAndArea({
  ...
  go2detail(v) {
    const urlDetail: any = {
      return: `/apps/apps-form-list/${this.projectCode}_xcxjjb&iframeAction=add`,
      // sheetCode: `${this.projectCode}_xcxjjb`,
