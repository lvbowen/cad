        ...
        <div v-if="!tableShow" class="messageTable">
          <el-scrollbar style="height: 100%">
            ...
            >
              ...
              <el-table-column prop="value" label="产值"> </el-table-column>
...
import {
  getscheduleAnalyseValueV3,
  getscheduleAnalyseStateV3,
  getscheduleAnalyseBimStateV3,
...
export default class shceduleViewV3 extends Vue {
  ...
  scheduleModelTitle: string = "模型显示";
  fillingModel: string = "";
  projectName: string = "";
  finshModel: object = {};
  fillModel: object = {};
  ...
  messagEchart(val) {
    this.scheduleData.forEach((e) => {
      ...
      if (e.model) {
        //@ts-ignore
        if (val.value == e.money && val.name == e.progressStateDesc) {
          //@ts-ignore
  ...
  yearClick() {
    ...
    getscheduleAnalyseValueV3(this.projectCode, 0, this.projectName).then(
      (res) => {
  ...
  monthClick() {
    ...
    getscheduleAnalyseValueV3(this.projectCode, 1, this.projectName).then(
      (res) => {
        this.stateData = res.data.realValueAxis ?? [];
        //@ts-ignore
        this.finshedData2.xAxis = res.data.dateAxis;
  ...
  getinit() {
    ...
    getscheduleAnalyseStateV3(this.projectCode, "", this.projectName,0).then(
      (res) => {
        this.scheduleData = res.data.progressStateDTOList;
        ...
        //@ts-ignore
        this.investmentData2.series = res.data.progressStateDTOList.map(
          (item) => {
    ...
    getscheduleAnalyseBimStateV3(this.projectCode, this.projectName).then(
      (res) => {
