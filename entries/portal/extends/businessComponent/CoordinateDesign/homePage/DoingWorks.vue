<template>
  <div class="doing-works full-height overflow-hidden table-content-scroll">
    <a-table
      :key="tableKey"
...
import { queryMyOutstandingItems } from "../../../service/CoordinateDesign/myHomePage";
...
export default class DoingWorks extends Vue {
