          ...
          >
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <img v-if="scope.row.date1 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date2 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date3 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date4 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date5 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date6 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date7 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date8 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            <el-table-column
              ...
              width="50">
              <template slot-scope="scope">
                <img v-if="scope.row.date9 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date10 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date11 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date12 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date13 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date14 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date15 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date16 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date17 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date18 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date19 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date20 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date21 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date22 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date23 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date24 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date25 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date26 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date27 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date28 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date29 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date30 == '1'" src="./Img/1.png" alt="" />
                <img
            ...
            >
              <template slot-scope="scope">
                <img v-if="scope.row.date31 == '1'" src="./Img/1.png" alt="" />
                <img
...
import { getPersonAttendance, getTeamTree, downloadPersonAttendanceInfo } from "./server/index.js";
