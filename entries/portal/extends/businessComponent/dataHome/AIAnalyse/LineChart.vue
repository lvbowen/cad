...
export default class LineChartNew extends Vue{
  ...
  getEchartOption():EChartOption<EChartOption.SeriesLines>{
    return {
      ...
      yAxis: {
        type: 'value',
        name: this.lineData.yAxis.length>0?this.lineData.yAxisName:"",
        nameTextStyle:{
          align:"right",
          color:"#c3c3c5",
      ...
      grid: {
        left: this.calcVwToPx(1.8),
        right: this.calcVwToPx(1.8),
        bottom: this.calcVwToPx(2.0833),
        top:this.calcVwToPx(1.8),
      },
      dataZoom:[
        {
          type: 'inside',
