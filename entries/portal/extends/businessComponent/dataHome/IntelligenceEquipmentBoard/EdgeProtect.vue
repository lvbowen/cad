<template>
  <div class="edge-protect full-height">
    <CardHeader title="临边防护" @changeTime="changeTime" @closeModal="closeModal"/>
    <div class="medium">
...
import {getEdgeProtectInfo} from "../../../service/api";
...
export default class EdgeProtect extends Vue {
  ...
  init() {
    ...
    getEdgeProtectInfo({appCode:this.projectCode??'',projectName:this.projectName??'',date:this.selectTime}).then((res)=> {
