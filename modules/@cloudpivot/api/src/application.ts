...
export interface ApiImplicitParam {
  schemaCode: string,
  relativeCode?: string,
  isMobile: boolean,
  queryActionType: number,
  queryActionRelativeType?: number
}
...
export interface SheetSecondImportParams {
  headColumns: Array<any>,
  secondImportData: Array<any>,
}
...
export interface appManagerModel {
  // 定义获取子管理员管理的应用模型过滤参数
  filterType?: string
}

export interface AppCodeByModelCodeParam {
  schemaCode: string
}
