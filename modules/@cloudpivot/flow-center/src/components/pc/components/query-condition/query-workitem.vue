        ...
        <a-form layout="inline">
          ...
          >
            <a-input
              ...
              class="workflow-name-input"></a-input>
          </a-form-item>
          <a-form-item
...
export default class QueryWorkitem extends Vue {
  ...
  formatData() {
    const obj = {
      ...
      participant: this.queryData.participant[0] ? this.queryData.participant[0].id : '',
      participantName: this.queryData.participant[0] ? this.queryData.participant[0].name : '',
