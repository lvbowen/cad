      ...
      <div v-if="approval.nodes && approval.nodes.length" class="form-approval__instances">
        <div v-if="approval.isCirculate" class="form-approval__instance">
          <div
            ...
            <span
              class="form-approval__circulations-users">已阅{{
              getCirculationsNum(node.circulations, 11)
            }}人、未阅{{ getCirculationsNum(node.circulations, 10) }}人</span>
        ...
        <template v-for="(node, g) in approval.nodes" v-else>
          <div
            ...
            <template v-if="approval.subInstanceActivity || (node.workItemStatus !== 1 && node.workItemStatus !== 2)">
              ...
              <template v-else>
                ...
                <workflow-status :status="node.workItemStatus" class="form-approval__status">
                </workflow-status>
            ...
            <template v-else-if="node.approvaler.length > 0">
              <div
                ...
                @click="approvalsDetails(node.approvaler, getWorkItemStatus(node.workItemStatus))">
            ...
            <div v-if="node.resources && node.resources.length" class="form-approval__signsture">
          ...
          <div
            ...
            style="align-items: flex-start;margin-left:0.98666665rem">
            <div class="form-approval__line" style="background: #e8e8e8;flex-basis: 0.3rem"></div>
          </div>
          <div v-if="node.circulations&&node.circulations.length>0" :key="g" class="form-approval__instance">
          ...
          <div :key="g" class="form-approval__trail" style="align-items: flex-start;margin-left:0.98666665rem;">
            <div class="form-approval__line" style="background: #e8e8e8;flex-basis: 0.3rem"></div>
          </div>
        </template>
      </div>
