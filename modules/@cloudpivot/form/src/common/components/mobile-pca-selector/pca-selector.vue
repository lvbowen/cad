  ...
  <div class="pca-selector">
    ...
    >
      <div class="pca-selector--options">
        ...
        <div class="options-content" v-if="isFocus">
          <h3-swiper :showDots="false" v-model="activeTab">
            ...
            <h3-swiper-item v-if="showTab[2] && showDistrict">
              <ul>
                <li
                  v-if="showEmpty"
                  @click="emptyClick('a')"
    ...
    switch (type) {
      ...
      case "c":
        this.pcaDate = this.pcaDate.filter(
          (res: any) => res.level === "province"
        );
        break;
      default:
        this.pcaDate = this.pcaDate.filter(
          (res: any) => res.level !== "district"
        );
