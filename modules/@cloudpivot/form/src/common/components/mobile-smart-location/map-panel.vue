          ...
          geocoder.getAddress(
              ...
              (status: any, result: any) => {
                if (status === "complete" && result.info === "OK") {
                  ...
                  const addComponent: any = result.regeocode.addressComponent;
                  const address = `${addComponent.township}${addComponent.street}${addComponent.streetNumber}`;
