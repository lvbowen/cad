...
@Component({
  name: "input-text",
  components: {
    PcaSelector: () => import("@cloudpivot/form/src/common/components/mobile-pca-selector/pca-selector.vue"),
    H3Textarea,
    MutilText,
...
export default class Address extends AddressControl {
  ...
  getPosition() {
    ...
    const smartlocation:any = this.$refs.smartlocation;
    if (smartlocation) {
        smartlocation.getFocus();
    }
