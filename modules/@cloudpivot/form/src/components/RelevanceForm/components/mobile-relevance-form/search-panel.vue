      ...
      <div class="search-bar">
        ...
        <div class="form-states">
          ...
          >
            ...
            ></i>
            <div class="inputButton" v-if="searchItem.type === 'search'">
              <el-input @change="searchClick" v-model="inputData" :placeholder="'请输入'+ inputName"></el-input>
...
import H3Scroll from "@cloudpivot/form/src/renderer/components/layout/h3-mescroll.vue";
...
export default class SearchPanel extends Vue {
  ...
  searchClick(){
    this.$emit("inputValue",this.inputData)
  }
