...
export interface PlatformServiceLike {
    ...
    scan(params: scanParams): void

    uploadImageFromCamera(params: uploadParams): void
}
...
export class BrowserService implements PlatformServiceLike {
    ...
    setTitle(title: string) {
        // console.log('wx小程序navigationBarTitleText会自动获取title',title)
        document.title = title;
        // document.title ='智慧工地BIM平台'
    }
