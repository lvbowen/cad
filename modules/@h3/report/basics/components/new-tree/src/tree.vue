  ...
  export default {
    ...
    watch: {
      defaultCheckedKeys(newVal) {
        this.treeStore.setDefaultCheckedKey(newVal);
      },

      defaultExpandedKeys(newVal) {
        this.treeStore.defaultExpandedKeys = newVal;
        this.treeStore.setDefaultExpandedKeys(newVal);
      },

      data(newVal) {
        this.treeStore.setData(newVal);
      },
      ...
      checkStrictly(newVal) {
        this.treeStore.checkStrictly = newVal;
      }
    },
    ...
    created() {
      ...
      this.$on('tree-node-drag-end', (event) => {
        ...
        if (draggingNode && dropNode) {
          ...
          if (dropType !== 'none') {
            this.treeStore.registerNode(draggingNodeCopy);
          }
